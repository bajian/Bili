package com.yanbober.support_library_demo.utils.cacheUtil;
...
import com.yanbober.support_library_demo.utils.imageUtil.BitmapTool;
...
public class ImageSDCacher {
	...
	public boolean saveBitmapToSDCard(Bitmap bitmap, String url,
		...
		if (FREE_SD_SPACE_NEEDED_TO_CACHE > FileUtil.freeSpaceOnSd()) {
	...
	private void removeCache(String cachePath) {
		...
		if (dirSize > MAX_CACHE_SIZE_NEEDED * 1024 * 1024
				|| FREE_SD_SPACE_NEEDED_TO_CACHE > FileUtil.freeSpaceOnSd()) {
